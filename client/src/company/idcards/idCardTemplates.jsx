...
import { User, BookOpen, Hash, Users, Bus, Droplets, Phone, GraduationCap, Stethoscope, Calendar } from "lucide-react";
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "center", padding: "12px 16px 8px" }}>
        <div style={{
          width: 78, height: 96, borderRadius: 10,
          border: `2px solid ${accent}`, background: "#f3f6fa",
      ...
      <div style={{ flex: 1, padding: "0 16px 8px" }}>
        {DETAIL_ROWS(s).map(({ icon: Icon, label, value }) => (
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "12px 16px 8px", borderBottom: `1px solid #f3f4f6` }}>
        ...
        <div>
          <p style={{ fontSize: 10, fontWeight: 800, color: primary, margin: 0, letterSpacing: 0.5, textTransform: "uppercase" }}>School Name</p>
      ...
      <div style={{ background: primary, padding: "6px 16px", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <span style={{ fontSize: 8, color: accent, fontWeight: 800, letterSpacing: 2, textTransform: "uppercase" }}>Student ID Card</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "center", paddingTop: 14, paddingBottom: 8, position: "relative", zIndex: 1 }}>
        <div style={{
          width: 82, height: 100, borderRadius: 10, border: `2.5px solid ${accent}`,
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: "8px 12px 4px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontSize: 8, fontWeight: 800, color: primary, letterSpacing: 1.5, textTransform: "uppercase" }}>Student ID Card</span>
    ...
    <div style={{
      ...
      <div style={{ position: "relative", background: primary, paddingTop: 22, paddingBottom: 46 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "0 16px" }}>
          ...
          <div>
            <p style={{ fontSize: 11, fontWeight: 800, color: "white", letterSpacing: 0.6, textTransform: "uppercase", margin: 0, lineHeight: 1.2 }}>School Name</p>
            <p style={{ fontSize: 7.5, color: accent, fontWeight: 700, letterSpacing: 1, margin: 0 }}>Location</p>
          </div>
        </div>
        {/* Wave divider */}
      ...
      <div style={{ display: "flex", justifyContent: "center", marginTop: -52, position: "relative", zIndex: 2 }}>
        <div style={{
          width: 88, height: 88, borderRadius: "50%", border: `4px solid ${accent}`, background: "#f3f6fa",
      ...
      <div style={{ background: primary, padding: "8px 16px", textAlign: "center", marginTop: 6 }}>
        <p style={{ fontSize: 9, fontWeight: 800, color: accent, letterSpacing: 2, textTransform: "uppercase", margin: 0 }}>Student ID Card</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{
      ...
      <div style={{ background: `linear-gradient(135deg, ${primary}, ${accent})`, padding: "18px 16px 14px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 12, fontWeight: 800, color: "white", letterSpacing: 1, textTransform: "uppercase", margin: 0 }}>School Name</p>
        <p style={{ fontSize: 7.5, color: "rgba(255,255,255,0.85)", fontWeight: 600, letterSpacing: 1.5, margin: 0 }}>STUDENT IDENTITY CARD</p>
      </div>

      <div style={{ display: "flex", justifyContent: "center", marginTop: -20 }}>
        <div style={{
          width: 84, height: 100, borderRadius: 10, border: `3px solid white`, background: "#f3f6fa",
